...
const surveySchema = new Schema({
  ...
  test1: { type: String, required: false, default: '' }, // Motivo de atención (opciones varias)
  test2: { type: String, required: false, default: '' }, // Motivo de atención (opciones varias)
